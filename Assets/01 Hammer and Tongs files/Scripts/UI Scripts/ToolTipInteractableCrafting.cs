...
public class ToolTipInteractableCrafting : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler
{
    ...
    private void Start()
    {
       // itemCostText = toolTip.GetChild(0).GetChild(0).GetComponent<TextMeshProUGUI>();
        ...
        smithingManager = GetComponent<SmithingManager>();
    }
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        itemCostText.text = "Sell value: " + (string)smithingManager.GetSellValue().ToString();
    }
